export default function EmployeesIcon() {
    return (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M1 17.9926V16.9926C1 15.3357 2.34315 13.9926 4 13.9926V13.9926" stroke="#2E3333" stroke-width="1.5"
                  stroke-linecap="round" stroke-linejoin="round"/>
            <path d="M23 17.9926V16.9926C23 15.3357 21.6569 13.9926 20 13.9926V13.9926" stroke="#2E3333"
